...
int main(){
    ...
    do {
        ...
        do {
            ...
            if (num1 < 1 || num1 > 9 || num2 < 1 || num2 > 9 || num3 < 1 || num3 > 9) {
                ...
                inputvalues(); // go back to start of loop if input is invalid
            }
            ...
            if ((num1 == 9 || num1 == 7 || num1 == 4) && (num2 == 9 || num2 == 7 || num2 == 4) && (num3 == 9 || num3 == 7 || num3 == 4)) {
    ...
    scanf("\n%c",&ans);
                ...
                //reset the table again for this part
                sudoku[0][0] = 0;
                sudoku[1][2] = 0;
                sudoku[2][0] = 0;
